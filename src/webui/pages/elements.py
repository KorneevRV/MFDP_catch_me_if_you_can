...
def create_navbar():
    ...
    with st.sidebar:
        ...
        st.page_link('pages/description.py', label='Описание сервиса')
        st.page_link('pages/ml.py', label='Новый запрос')
        st.page_link('pages/history_req.py', label='История запросов')
